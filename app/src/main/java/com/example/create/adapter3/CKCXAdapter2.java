 ...
 */
public class CKCXAdapter2 extends ArrayAdapter<CK> {
    private int layout;
    private List<CK> rks;

    public CKCXAdapter2(@NonNull Context context, int resource, @NonNull List<CK> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (position == 0) {
            ...
            CK rk = getItem(position - 1);
            holder.itemGys.setText(rk.getGys());
            holder.itemRkr.setText(rk.getJsr());
